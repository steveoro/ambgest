#
# Schedule rows list/grid component implementation with date filtering support
#
# - author: Steve A.
# - vers. : 0.35.20130221
#
class FilteredSchedulesList < Netzke::Basepack::BorderLayoutPanel
...
#    }
  ...
  component :list_view_grid do
    {
      :class_name => "SchedulesGrid",
      # [20130213] Using lambda here enforces the default sorting as FIXED: since alters
      # the scope order itself, it disables the on-click column ordering.
      :scope => [
