...
class ReceiptsGrid < EntityGrid
  ...
  def configuration
    ...
    super.merge(
      ...
      :enable_pagination => ( toggle_pagination = AppParameter.get_default_pagination_enable_for( :receipts ) ),
      ...
      :rows_per_page => ( toggle_pagination ? AppParameter.get_default_pagination_rows_for( :receipts ) : 1000000000000 ),
      :min_width => 750,
